    ...
    public constructor(x: number, y: number, type: WeaponType, infinite_ammo?: boolean)
    {
        ...
        switch (type)
        {
            ...
            case 'smg':
                ...
                stats = { 
                    bullet_dmg: 7, shoot_cd: 120, bullet_speed: 7, 
            ...
            case 'rocketlauncher':
                ...
                stats = { 
                    bullet_dmg: 15, shoot_cd: 2000, bullet_speed: 6,
            ...
            case 'shotgun':
                ...
                stats = {
                    bullet_dmg: 10, shoot_cd: 1000, bullet_speed: 6, mag_ammo: 4, total_ammo: 12,
                    reload_time: 1000,
                    angle_start: a_start, 
                    bullet_nr:   blt_nr,
